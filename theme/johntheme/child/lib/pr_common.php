...
define('PR_TEMPLATE_URL', G5_THEME_URL.'/template');
define('PR_PAGE_PATH', PR_THEME_CHILD.'/page');
define('PR_LIB_PATH', PR_THEME_CHILD.'/lib');
define('PR_ADM_URL', G5_THEME_URL.'/child/adm');
define('PR_CHILD_URL', G5_THEME_URL.'/child');
define('PR_CHILD_PATH', G5_THEME_PATH.'/child');
...
//필요한 테이블이름을 정의
$pr['pr_table_exp'] = G5_TABLE_PREFIX.'pr_expansion';							//기본 옵션저장이나 필요한 확장을 담당합니다.. varchar 타입을 저장합니다.

//기본 config를 할당
$cfsql = " select exp_value from {$pr['pr_table_exp']} where exp_type = 'pr_config' ";
...
//필요한 데이터베이스를 생성한다.
include_once(PR_THEME_CHILD . '/lib/pr_install.php');
...
// $config['cf_bbs_rewrite'] = 'true';
// include_once( PR_CHILD_PATH.'/route.php');
?>
